...
namespace Eva.Infra.EntityFramework.Migrations
{
    ...
    [Migration("20240511073948_permitMapping")]
    partial class permitMapping
    {
            ...
            modelBuilder.Entity("Eva.Core.Domain.Models.PermissionEndPointMapping", b =>
                {
                    ...
                    b.ToTable("PermissionEndPointMapping");
                });
            ...
            modelBuilder.Entity("Eva.Core.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2024, 5, 11, 11, 9, 48, 685, DateTimeKind.Local).AddTicks(6777),
                            Email = "eva@eva.com",
                            IsAdmin = true,
                            IsDeleted = false,
                            ModifiedBy = 1,
                            ModifiedOn = new DateTime(2024, 5, 11, 11, 9, 48, 685, DateTimeKind.Local).AddTicks(6786),
